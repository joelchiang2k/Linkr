...
public class ChatController {
    private static String CHAT_ENGINE_PROJECT_ID = "b091b0e4-d6ed-4e43-bb88-f64080b2c47b";
    private static String CHAT_ENGINE_PRIVATE_KEY = "4c3465ae-11f2-4118-930a-fe62c1b5718e";

    @CrossOrigin
    @RequestMapping(path = "/chated", method = RequestMethod.POST) //aka login
    ...
    @CrossOrigin
    @RequestMapping(path = "/chat", method = RequestMethod.POST) //aka sign up
